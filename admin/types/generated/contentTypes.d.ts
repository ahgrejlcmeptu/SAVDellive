...
export interface ApiAboutAbout extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::about.about'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    reviews: Schema.Attribute.Component<'block.reviews', false>;
    seo: Schema.Attribute.Component<'block.seo', false>;
    social: Schema.Attribute.Component<'block.social', false>;
...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    card: Schema.Attribute.Component<'component.article-card', false> &
      Schema.Attribute.Required;
    ...
    > &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'\u041D\u043E\u0432\u043E\u0441\u0442\u0438'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiBranchBranch extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    map: Schema.Attribute.Media<'images' | 'files'>;
    mode: Schema.Attribute.Component<'ui.short-text', true>;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    waiting: Schema.Attribute.Component<'ui.short-text', true>;
  };
}
...
export interface ApiCatalogCatalog extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    declaration: Schema.Attribute.Relation<
      'oneToOne',
...
export interface ApiContactContact extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    requisite: Schema.Attribute.Blocks;
    seo: Schema.Attribute.Component<'block.seo', false>;
    title: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiDeclarationDeclaration extends Struct.CollectionTypeSchema {
  collectionName: 'declarations';
  info: {
    description: '';
    displayName: '\u041A\u0430\u0440\u0442\u043E\u0447\u043A\u0438 \u0440\u0435\u043A\u043B\u0430\u043C\u044B';
    pluralName: 'declarations';
    singularName: 'declaration';
  };
  options: {
    draftAndPublish: false;
  };
...
export interface ApiDeliveryDelivery extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    delivery: Schema.Attribute.Blocks;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    payment: Schema.Attribute.Blocks;
    publishedAt: Schema.Attribute.DateTime;
    seo: Schema.Attribute.Component<'block.seo', false>;
    title: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiHomeHome extends Struct.SingleTypeSchema {
  ...
  attributes: {
    about: Schema.Attribute.Component<'block.about', false> &
      Schema.Attribute.Required;
    advantages: Schema.Attribute.Component<'block.advantages', false> &
      Schema.Attribute.Required;
    banners: Schema.Attribute.Component<'block.banners', false> &
      Schema.Attribute.Required;
    categories: Schema.Attribute.Component<'block.categories', false> &
      Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::home.home'> &
      Schema.Attribute.Private;
    news: Schema.Attribute.Component<'block.news', false> &
      Schema.Attribute.Required;
    popular: Schema.Attribute.Component<'block.popular', false>;
    publishedAt: Schema.Attribute.DateTime;
    reviews: Schema.Attribute.Component<'block.reviews', false> &
      Schema.Attribute.Required;
    seo: Schema.Attribute.Component<'block.seo', false> &
      Schema.Attribute.Required;
    stories: Schema.Attribute.Component<'block.stories', false> &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'\u0432 \u043E\u0431\u0440\u0430\u0431\u043E\u0442\u043A\u0435'>;
...
export interface ApiPresentPresent extends Struct.CollectionTypeSchema {
  collectionName: 'presents';
  info: {
    description: '';
    displayName: '\u041F\u043E\u0434\u0430\u0440\u043A\u0438';
    pluralName: 'presents';
    singularName: 'present';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    compound: Schema.Attribute.Text;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    img: Schema.Attribute.Media<'images' | 'files'>;
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    statuses: Schema.Attribute.Relation<'manyToMany', 'api::status.status'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiRecallRecall extends Struct.SingleTypeSchema {
  collectionName: 'recalls';
  info: {
    description: '';
    displayName: '\u041E\u0442\u0437\u044B\u0432\u044B';
    pluralName: 'recalls';
...
export interface ApiReviewReview extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ask: Schema.Attribute.Component<'component.ask', false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    review: Schema.Attribute.Component<'component.review', false>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiSettingSetting extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    presents: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<true>;
...
export interface ApiSuccessfullySuccessfully extends Struct.SingleTypeSchema {
  collectionName: 'successfullies';
  info: {
    description: '';
    displayName: '\u0423\u0441\u043F\u0435\u0448\u043D\u043E\u0435 \u043E\u0444\u043E\u0440\u043C\u043B\u0435\u043D\u0438\u0435';
    pluralName: 'successfullies';
    singularName: 'successfully';
  };
  options: {
    draftAndPublish: false;
  };
...
export interface ApiTidingTiding extends Struct.SingleTypeSchema {
  collectionName: 'tidings';
  info: {
    description: '';
    displayName: '\u041D\u043E\u0432\u043E\u0441\u0442\u0438 \u0438 \u0430\u043A\u0446\u0438\u0438';
    pluralName: 'tidings';
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::declaration.declaration': ApiDeclarationDeclaration;
      ...
      'api::successfully.successfully': ApiSuccessfullySuccessfully;
      'api::tiding.tiding': ApiTidingTiding;
